# Generated by Django 5.0.4 on 2024-05-28 01:50
...
def add_initial_data(apps, schema_editor):
    ...
    RuleSet.objects.create(name='quarterly_leave', max_days_allowed=4.5, duration='quarterly')
    ...
    quarterly_leave = RuleSet.objects.get(name='quarterly_leave')
    ...
    LeaveType.objects.create(name='emergency_leave', rule_set=quarterly_leave)
    LeaveType.objects.create(name='pto', rule_set=quarterly_leave)
    LeaveType.objects.create(name='sick_leave', rule_set=quarterly_leave)
    LeaveType.objects.create(name='wfh', rule_set=quarterly_leave)
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('LeaveTrackingApp', '0002_alter_ruleset_duration'),
    ]
